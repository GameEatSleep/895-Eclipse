...
public class AspectJUtils {
	...
	public static boolean dynamicallyLoadAspectJAgent() {
		...
		try {
			...
			String jarFilePath= System.getProperty("user.dir")+File.separator+"target"+File.separator+"alternateLocation"+File.separator+"aspectjweaver-1.8.11.jar";
	...
	public static CallDepthAnalysis exec(Class<?> klass, String filePath) throws IOException, InterruptedException {
		 ...
		 */
		String aspectJarPath = System.getProperty("user.dir")+File.separator+"target"+File.separator+"alternateLocation"+File.separator+"aspect-1.0.0.1.jar";
		String aspectRTPath = System.getProperty("user.dir")+File.separator+"target"+File.separator+"alternateLocation"+File.separator+"aspectjrt-1.8.11.jar";
		String aspectWeaverPath = System.getProperty("user.dir")+File.separator+"target"+File.separator+"alternateLocation"+File.separator+"aspectjweaver-1.8.11.jar";
	...
	static CallDepthAnalysis getCallDepth(File f1)
		...
		String filePath = f1.getCanonicalPath().substring(0, f1.getCanonicalPath().lastIndexOf(File.separator));
		String packageName = "";
